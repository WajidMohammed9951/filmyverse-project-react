...
const Card = () => {
  ...
  return (
    ...
    <div className='flex flex-wrap justify-between font-bold p-3 mt-7' >
      {data.map((e, i) => {
        return (
          <div className='Card'>
            <img className='h-80 p-1 shadow-lg cursor-pointer hover:translate-y-1 ' src={e.img} />
            <h1><span className='text-gray-500'>Name : </span>{e.name}r</h1>
